...
static void annual_performance()
    ...
    int		acct, j;
    double	totdeposits = 0, totreturns = 0;
    int		yix;
    ...
    printf("\n\nYear   Deposits    Investment       Balance          Gain          Roi\n");
    printf("                     Return\n\n");
	...
	if (i == nacctyears - 1 || acctyear[i].year != acctyear[i + 1].year) {
	    ...
	    totreturns += years[nyears].balance - previous - years[nyears].deposits;
	...
	years[0].year, years[0].deposits,
	years[0].balance - years[0].deposits,
	years[0].balance, est(0, lastdix + 1));
	...
	printf("%4d %10.2f    %10.2f    %10.2f    %10.2f%% %10.2f%%\n",
	    ...
	    years[i].year,
            ...
            years[i].deposits,
            /* investment return */
	    years[i].balance - years[i - 1].balance - years[i].deposits,
            /* balance */
	    years[i].balance,
